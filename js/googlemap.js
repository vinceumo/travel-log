function initialize() {
    ...
    var marker = new google.maps.Marker({
        position: new google.maps.LatLng(21.052377, 105.823016),
        map: map,
        title: "Hanoi",
    ...
    var marker2 = new google.maps.Marker({
        position: new google.maps.LatLng(28.6454414, 77.0907573),
        map: map,
        title: "delhi",
        icon: image
    });
    ...
    //--> agra
    var marker2 = new google.maps.Marker({
        position: new google.maps.LatLng(27.1761745, 77.980013),
        map: map,
        title: "agra",
        icon: image
    });
    ...
    //--> jaipur
    var marker2 = new google.maps.Marker({
        position: new google.maps.LatLng(26.8852108, 75.7905578),
        map: map,
        title: "jaipur",
        icon: image
    });
    ...
    //--> jaisalmer
    var marker2 = new google.maps.Marker({
        position: new google.maps.LatLng(26.9035788, 70.8947302),
        map: map,
        title: "jaisalmer",
        icon: image
    });
    //--> jodhpur
    var marker2 = new google.maps.Marker({
        position: new google.maps.LatLng(26.2703528, 73.0305433),
        map: map,
        title: "jodhpur",
        icon: image
    });
    //--> Udaipur
    var marker2 = new google.maps.Marker({
        position: new google.maps.LatLng(24.5872025, 73.7108014),
        map: map,
        title: "Udaipur",
        icon: image
    });
    ...
    //--> PONDICHERRY
    var marker2 = new google.maps.Marker({
        position: new google.maps.LatLng(11.931720, 79.833836),
        map: map,
        title: "Pondicherry",
        icon: image
    });
    ...
    var marker3 = new google.maps.Marker({
        position: new google.maps.LatLng(9.953967, 76.255610),
        map: map,
        title: "Kochin",
        icon: image
    });
